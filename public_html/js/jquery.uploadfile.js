...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            //dragDropStr: "<span><b>Arrastrar y soltar archivo.</b></span>",
            abortStr: "Abortar",
            cancelStr: "Cancelar",
            deletelStr: "Eliminar",
            doneStr: "Listo",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "Extension no permitida: Solo permitidos ",
            sizeErrorStr: "No permitido. Allowed Max size: ",
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                //add custom code
                if(s.formData.semester==-1){
                    if (s.showError) $("<div style='color:red;'><b>Por favor escoger bimestre</b> </div>").appendTo(obj.errorLog);
                    continue;
                }
                //end custom code
                var ts = s;
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            fileInput.change(function () {
                ...
                form.hide();
                s.formData={semester:$("#semester").val()};//add semester input
        ...
        function createProgressDiv(obj, s) {
            this.msg = $("<div class='ajax-file-upload-msg'></div>")
        ...
        function ajaxFormSubmit(form, s, pd, fileArray, obj) {
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                    $("#msg").html('');
                    if(data.status.code=="200"){//modify code
                        ...
                        $("#msg").append("<span style='color:red;'>ERROR: " + data.status.description + "</span>");
                        s.onSuccess.call(this, fileArray, data, xhr);
