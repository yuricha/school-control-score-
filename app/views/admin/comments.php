					...
					<div class="row">
						<div class="col-xs-12">
							<form id="form_post" method="post">
								...
								<div class="row">
									<div class="col-xs-6">
										<label for="title">Título: </label><input type="text" id="title" name="title" class="form-control"/>
									</div>
									<div class="col-xs-6">
										<label for="size">Estado: </label>
...
<script type="text/javascript">
	...
	function initSection()
	{
		...
		$('#auto_search').keydown(AUTO_KEY_SEARCH_handler);
	...
	function FORM_SUBMIT_handler()
	{
		...
		$.post("<?php echo URL::to('admin/comments/save'); ?>", params, function(_data){
			if($('#comment_id').val() == '')
			{
	...
	function AUTO_KEY_SEARCH_handler()
	{
		clearTimeout(searchTimeout);
		searchTimeout = setTimeout(searchByAutoUsers, 180);
	}

	function KEY_SEARCH_handler()
	{
		clearTimeout(searchTimeout);
		searchTimeout = setTimeout(searchUsers, 180);
	}
    ...
    function delete_handler(){
        $.get("<?php echo URL::to('admin/comments/delete'); ?>"+'/'+this.id, '', function(_data){
